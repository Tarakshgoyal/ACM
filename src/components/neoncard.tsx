    ...
    return (
        ...
        >
            ...
            `,
                ...
                {/* Ensure AnimatePresence wraps only if isHovered is true */}
                <AnimatePresence>
                    {isHovered && (
                        <motion.div
                            initial={{ opacity: 0 }}
...
export default function NeonCards({ info }: { info: any[] }) {
    return (
        <div className="flex h-[600px] w-full flex-col gap-6 p-8 lg:h-[360px] lg:flex-row">
            {info.map((item, key) => (
                <NeonCard
                    className="flex-1"
