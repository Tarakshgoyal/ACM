...
const HeroContent = () => {
    return (
        <div className='flex flex-row items-center justify-center px-4 sm:px-8 lg:px-20 mt-[-320] w-full z-[20]'>
            <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
                ...
                <div className='flex flex-col gap-6 mt-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white max-w-[600px] w-auto'>
                    <div>UPES<span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500'> OPEN</span></div>
                    COMMUNITY
                </div>
